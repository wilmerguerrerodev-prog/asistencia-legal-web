...
class ConversationScreen extends StatefulWidget {
  ...
  const ConversationScreen({super.key,  required this.name, required this.image, required this.channelID,required this.date,required this.bookingID});
                            ...
                            return Row(
                              children: [
                                Container(
                                  ...
                                  child: SizedBox(
                                      width:ResponsiveHelper.isMobile(context) ? Get.width:Get.width / 4,
                                      child: ChannelList(channelList:conversationController.channelList,)),
                                ),
                                                  ...
                                                  Expanded(
                                                    child: TextField(
                                                      ...
                                                      decoration: InputDecoration(
                                                        ...
                                                        hintStyle: ubuntuRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.8), fontSize: 16),),
                                                    ),
                                                  ),
                                                  Row(
                                                    children: [
