  ...
  Widget sellerInfoItem({required SellerInfoModel sellerInfoModel,required BuildContext context}){
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
        Row(children: [
          Icon(sellerInfoModel.leadingIcon,color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(.5)),
          const SizedBox(width: Dimensions.paddingSizeSmall),
          Text(sellerInfoModel.title!,style: ubuntuMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(.5),fontSize: Dimensions.fontSizeLarge)),
        ]),
