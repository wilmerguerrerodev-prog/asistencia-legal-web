...
import 'package:getdash/feature/product/product_list.dart';
...
class _AllUsersScreenState extends State<ProductListScreen> {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children:  [
                                    ...
                                    CommonAddSection(title: 'product_list'.tr, addBtnTitle: 'add_new_product'.tr,),
                                    const SizedBox(height: Dimensions.paddingSizeExtraMoreLarge),
