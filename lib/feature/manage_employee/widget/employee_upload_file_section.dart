...
class EmployeeUploadFileSection extends StatelessWidget {
  const EmployeeUploadFileSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text("personal_information".tr,style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
        const SizedBox(height: Dimensions.paddingSizeExtraMoreLarge),
        if(ResponsiveHelper.isMobile(context))
          Padding(
            padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault),
            child: Text('profile_photo'.tr,style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeDefault),),
          ),
        Row(
          children: [
            Container(
