...
class ConductorController extends GetxController {
  ...
  final List<OpcionIncidente> opcionesIncidentes = const [
    ...
    OpcionIncidente(
      ...
      emoji: "👮",
      titulo: "Operativo de Tránsito / Retención",
      descripcion: "Revisión documental o intento de grúa",
  ...
  void responderSeveridad(SeveridadVictimas severidad) {
    ...
    if (severidad == SeveridadVictimas.fallecido || severidad == SeveridadVictimas.heridos) {
      // Causal penal crítica: se omite daños materiales y va directo al dictamen de máxima alerta penal
      daniosGraves.value = true;
      pasoActual.value = 2;
    } else if (tipoSeleccionado.value == TipoIncidente.agresionProblemaPersonal) {
  ...
  void responderHeridos(bool tieneHeridos) {
    responderSeveridad(tieneHeridos ? SeveridadVictimas.heridos : SeveridadVictimas.ninguna);
  }
  ...
  DictamenLegal obtenerDictamenIA() {
    ...
    if (tipo == TipoIncidente.operativoTransito) {
      return DictamenLegal(
        ...
        normativa: "Marco legal: Garantías ciudadanas y límites de control operativo (Art. 390 COIP).",
        reglas: const [
        ...
        accionInmediata: "Si el agente insiste en trasladar el taxi en grúa, presiona el botón y pon a tu abogado en altavoz.",
      );
    }
    ...
    if (tipo == TipoIncidente.agresionProblemaPersonal) {
      if (severidad == SeveridadVictimas.fallecido || severidad == SeveridadVictimas.heridos) {
        return DictamenLegal(
          ...
          saludo: "Hola $nombreConductor ($unidadTaxi), tu integridad es prioridad.",
          titulo: "Agresión Física con Lesiones o Peligro Inminente",
          normativa: "Marco legal: Delito de lesiones flagrantes y legítima defensa (Art. 33 y 152 COIP).",
          reglas: const [
          ...
          accionInmediata: "Tu abogado asignado intervendrá de inmediato para coordinar la captura en flagrancia y la denuncia.",
        );
      }
      ...
      return DictamenLegal(
        ...
        normativa: "Marco legal: Contravenciones de cuarta clase y resolución pacífica en vía pública.",
        reglas: const [
        ...
        accionInmediata: "Presiona el botón para que el abogado dialogue en altavoz con el usuario y respalde tu cobro legal.",
      );
    }
    ...
    if (tipo == TipoIncidente.meChoque) {
      if (severidad == SeveridadVictimas.fallecido) {
        return DictamenLegal(
          ...
          normativa: "Marco legal: Procedimiento en presunto Homicidio Culposo (Art. 377 COIP) y Flagrancia.",
          reglas: const [
          ...
          accionInmediata: "ALERTA CRÍTICA: Tu abogado penalista está asignado con prioridad urgente. Presiona llamar inmediatamente.",
        );
      }
      ...
      if (severidad == SeveridadVictimas.heridos) {
        return DictamenLegal(
          ...
          saludo: "Hola $nombreConductor ($unidadTaxi), mantén la calma.",
          titulo: "Accidente con Víctimas Heridas (Presunto Delito de Lesiones)",
          normativa: "Marco legal: Delito de tránsito con lesiones (Art. 379 y 380 COIP) y auxilio obligatorio.",
          reglas: const [
          ...
          accionInmediata: "Comunícate ahora con tu abogado para estructurar la defensa previa a la llegada del perito.",
        );
      }
      ...
      if (graves) {
        return DictamenLegal(
          ...
          normativa: "Marco legal: Accidente con solo daños materiales (Art. 380 COIP) — Sin Flagrancia Penal.",
          reglas: const [
          ...
          accionInmediata: "Tu abogado te guiará en la negociación o en el peritaje técnico vehicular.",
        );
      }
      ...
      return DictamenLegal(
        ...
        normativa: "Marco legal: Conciliación directa entre conductores y despeje de calzada.",
        reglas: const [
        ...
        accionInmediata: "Presiona el botón de llamada para que el abogado asesore el acuerdo en tiempo real.",
      );
    }
    ...
    if (severidad == SeveridadVictimas.fallecido) {
      return DictamenLegal(
        ...
        normativa: "Marco legal: Protección de la parte afectada en siniestro con víctima mortal (Art. 377 COIP).",
        reglas: const [
        ...
        accionInmediata: "Tu abogado penalista intervendrá de inmediato para evitar cualquier imputación errónea en Fiscalía.",
      );
    }
    ...
    if (severidad == SeveridadVictimas.heridos) {
      return DictamenLegal(
        ...
        normativa: "Marco legal: Cobertura médica SPPAT y reclamo de indemnización contra causante.",
        reglas: const [
        ...
        accionInmediata: "Llama a tu abogado para que supervise que el parte policial señale al verdadero causante.",
      );
    }
    ...
    if (graves) {
      return DictamenLegal(
        ...
        normativa: "Marco legal: Reparación integral de daños y Lucro Cesante por días no laborados.",
        reglas: const [
        ...
        accionInmediata: "Comunícate con tu abogado para que exija formalmente la indemnización al conductor o a su seguro.",
      );
    }
    ...
    return DictamenLegal(
      ...
      normativa: "Marco legal: Arreglo económico voluntario en el sitio por daños materiales.",
      reglas: const [
      ...
      accionInmediata: "Llama a tu abogado para que fije el valor justo del daño y convenza al tercero de pagar de inmediato.",
    );
  }
}
